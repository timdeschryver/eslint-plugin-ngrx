...
| [ngrx/no-effects-in-providers](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/no-effects-in-providers.md)                                     | An `Effect` should not be listed as a provider if it is added to the `EffectsModule`.                                             | problem     | error (Possible Errors) | Yes     | No           |
...
| [ngrx/no-reducer-in-key-names](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/no-reducer-in-key-names.md)                                                     | Avoid the word "reducer" in the key names.                                                                        | suggestion  | warn (Best Practices)  | No      | No           |
