...
| [ngrx/no-dispatch-in-effects](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/no-dispatch-in-effects.md)                                       | An `Effect` should not call `store.dispatch`.                                                                                     | suggestion  | warn (Possible Errors)  | Yes     | Yes             | No           | No                        |
