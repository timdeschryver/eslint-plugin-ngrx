...
| Name                                                                                                                                                                    | Description                                                                                                                      | Recommended | Category                | Fixable | Has suggestions | Configurable | Requires type information |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------------- | ------- | --------------- | ------------ | ------------------------- |
| [ngrx/avoid-cyclic-effects](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/avoid-cyclic-effects.md)                                           | Avoid `Effect` that re-emit filtered actions.                                                                                    | problem     | error                   | No      | No              | No           | Yes                       |
...
| [ngrx/use-selector-in-select](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/use-selector-in-select.md)                                                       | Using a selector in the `select` is preferred over `string` or `props drilling`. | suggestion  | warn     | No      | No              | No           | No                        |
