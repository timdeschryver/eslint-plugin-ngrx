...
| [ngrx/select-in-selector-name](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/select-in-selector-name.md)                                                     | Name Selector Functions as `selectThing`                                                                         | suggestion  | warn (Best Practices)  | No      | No           |
