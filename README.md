...
| [ngrx/prefer-action-creator](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/prefer-action-creator.md)                                                         | Using an `action creator` is preferred over `Action class`.                                                       | problem     | warn (Best Practices)  | No      | No              | No           | No                        |
