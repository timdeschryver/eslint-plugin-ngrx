...
| [ngrx/avoid-duplicate-actions-in-reducer](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/avoid-duplicate-actions-in-reducer.md)                               | A `Reducer` should handle an `Action` once.                                                                       | problem     | warn (Best Practices)  | No      | No              | No           |
