...
| [ngrx/use-action-creator-in-of-type](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/use-action-creator-in-of-type.md)                         | Using an `action creator` in `ofType` is preferred over `string`.                                                                 | problem     | warn (Best Practices)   | No      | No              | No           | No                        |
