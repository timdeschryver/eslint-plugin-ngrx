...
| [ngrx/select-in-selector-names](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/select-in-selector-names.md)                                                   | Name Selector Functions as selectThing                                                                            | suggestion  | warn (Best Practices)  | No      | No           |
