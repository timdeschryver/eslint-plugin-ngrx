...
| [ngrx/selectors-start-with-select](https://github.com/timdeschryver/eslint-plugin-ngrx/tree/main/docs/rules/selectors-start-with-select.md)                                             | The selector should start with "select", for example "selectThing"                                                | suggestion  | warn (Best Practices)  | No      | No           |
